...
cat > $tmpf << 'EOF'
	{
          ...
          renderer:function(value){
              ...
              // 不带主板温度
              return ` 核心1: ${c0} ℃ | 核心2: ${c1} ℃ | 核心3: ${c2} ℃ | 核心4: ${c3} ℃ | 核心5: ${c4} ℃ | 核心6: ${c5} ℃ `
              // 带主板温度
              // return `Package: ${p0} ℃ || 核心1: ${c0} ℃ | 核心2: ${c1} ℃ | 核心3: ${c2} ℃ | 核心4: ${c3} ℃ | 核心5: ${c4} ℃ | 核心6: ${c5} ℃ || 主板: ${b0} ℃ | ${b1} ℃ `
            }
    },
	{
          itemId: 'MHz',
	...
	// 风扇转速
	{
          ...
          textField: 'thermalstate',
          renderer:function(value){
			  const fan1 = value.match(/fan2:.*?\ ([\d.]+) R/)[1];
			  const fan2 = value.match(/fan3:.*?\ ([\d.]+) R/)[1];
